...
INSERT INTO Masked_Ugyfel (LOGIN, EMAIL, NEV, SZULEV, NEM, CIM)
VALUES
...
CREATE USER Sanyi WITHOUT Login; -- neki titkosítva kell látnia az adatokat
GRANT SELECT ON Masked_Ugyfel TO Sanyi

EXECUTE AS User= 'Sanyi';
SELECT * FROM Masked_Ugyfel -- a titkosított Ugyfel táblát látja Sanyi lekérdezésnél
REVERT


GRANT UNMASK TO Sanyi -- most már láthatja az eredeti adatokat

EXECUTE AS User= 'Sanyi';
SELECT * FROM Masked_Ugyfel -- most már mindent lát
REVERT